        ...
        <Container>
          ...
          <Row>
            {kelasTerbaru.map((kelas)=>{
              return <Col key={kelas.id} className="rounded-bottom">
                  ...
                  <div className="ket d-flex justify-content-between align-items-center px-3 pb-3"> 
                    <p className="m-0 text-primary fw-bold">Gratis</p>
                    <button className="btn btn-danger rounded-1">Mulai Belajar</button>
                  </div>
                 </Col>
              })}
